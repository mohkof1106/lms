-- Update employee cost calculation to use dynamic settings from company_settings and holidays tables
-- Replaces hardcoded values (8 hours/day, 13 holidays) with database-driven configuration
